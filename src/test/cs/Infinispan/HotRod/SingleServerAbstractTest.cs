...
namespace Infinispan.HotRod.Tests
{
    ...
    public abstract class SingleServerAbstractTest
    {
        ...
        protected virtual string getRequestedConfig() {
        ...
        public void StartHotrodServer()
        {
            ...
            hrServer.StartInfo.FileName = buildStartCommand(jbossHome, getRequestedConfig());
        ...
        private string buildStartCommand(string homePath, string config = "standalone.xml")
        {
            if (PlatformUtils.isUnix()) {
                return Path.Combine(homePath, "bin/standalone.sh -c " + config);
            } else {
                return Path.Combine(homePath, "bin\\standalone.bat -c " + config);
            }
        }
